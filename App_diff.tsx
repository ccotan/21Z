...
// Компоненты страниц будут добавлены в следующем файле из-за ограничения размера
function AuthPage() {
...
function StudentsPage({ students, showToast, userId }: { students: Student[]; showToast: (m: string) => void; userId: string }) {
